...
/*This SQL script is to create the Classic Models Schema. This was not written by me, it is a free resource.*/
/*Select everything and execute the script to create the Classic Models schema*/
/**/
